...
const cashViewContent = `<div class="row">
    <div class="col-12">
...
fs.writeFileSync('views/cash.ejs', cashViewContent, 'utf8');
console.log('✅ Cash view file created successfully!');
console.log('File size:', fs.statSync('views/cash.ejs').size, 'bytes');
