                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="instrument" required>
                            ...
                            <option value="Flute" ${student.instrument === 'Flute' ? 'selected' : ''}>Flute</option>
                            <option value="Saxophone" ${student.instrument === 'Saxophone' ? 'selected' : ''}>Saxophone</option>
                            <option value="Trumpet" ${student.instrument === 'Trumpet' ? 'selected' : ''}>Trumpet</option>
                            <option value="Cello" ${student.instrument === 'Cello' ? 'selected' : ''}>Cello</option>
                            <option value="Clarinet" ${student.instrument === 'Clarinet' ? 'selected' : ''}>Clarinet</option>
                            <option value="Qanun" ${student.instrument === 'Qanun' ? 'selected' : ''}>Qanun</option>
                            <option value="Ney" ${student.instrument === 'Ney' ? 'selected' : ''}>Ney</option>
                            <option value="Tabla" ${student.instrument === 'Tabla' ? 'selected' : ''}>Tabla</option>
                        </select>
                    </div>
                    <div class="mb-3">
